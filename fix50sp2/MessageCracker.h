...
{  
  ...
  class UpdateMonitorPageRequest; 
  class MonitorRequestAck; 
  class MarketDataAck;
 ...
 virtual void onMessage( const IOI&, const FIX::SessionID& ) 
  ...
  virtual void onMessage( const SetupMonitorRequest&, const FIX::SessionID& ) 
    { throw FIX::UnsupportedMessageType(); }
  virtual void onMessage( const UpdateMonitorPageRequest&, const FIX::SessionID& ) 
    { throw FIX::UnsupportedMessageType(); }
  virtual void onMessage( const MonitorRequestAck&, const FIX::SessionID& ) 
    { throw FIX::UnsupportedMessageType(); }
  virtual void onMessage( const MarketDataAck&, const FIX::SessionID& ) 
    { throw FIX::UnsupportedMessageType(); }
 ...
 virtual void onMessage( UpdateMonitorPageRequest&, const FIX::SessionID& ) {} 
 virtual void onMessage( MonitorRequestAck&, const FIX::SessionID& ) {} 
 virtual void onMessage( MarketDataAck&, const FIX::SessionID& ) {} 
...
public:
              ...
              const FIX::SessionID& sessionID )
  {
    ...
    if( msgTypeValue == "UMPQ" )
      onMessage( (const UpdateMonitorPageRequest&)message, sessionID );
    else
    if( msgTypeValue == "USMQK" )
      onMessage( (const MonitorRequestAck&)message, sessionID );
    else
    if( msgTypeValue == "UMDA" )
      onMessage( (const MarketDataAck&)message, sessionID );
...
void crack( Message& message, 
            const FIX::SessionID& sessionID )
  {
    ...
    if( msgTypeValue == "UMPQ" )
      onMessage( (UpdateMonitorPageRequest&)message, sessionID );
    else
    if( msgTypeValue == "USMQK" )
      onMessage( (MonitorRequestAck&)message, sessionID );
    else
    if( msgTypeValue == "UMDA" )
      onMessage( (MarketDataAck&)message, sessionID );
    else onMessage( message, sessionID );
  }
