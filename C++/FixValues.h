...
namespace FIX
{
  ...
  const char MsgType_UpdateMonitorPageRequest[] = "UMPQ";
  const char MsgType_MonitorRequestAck[] = "USMQK";
  const char MsgType_MarketDataAck[] = "UMDA";
  ...
  const char MonitorSortOption_ABSOLUTE_POSITIONBYCONTRIBUTOR = 'A';
  const char MonitorSortOption_MATURITY_BLOOMBERGSORTBYMATURITY = 'M';
  ...
  const char SecurityIDSourceOverride_ISIN[] = "4";
  const char SecurityIDSourceOverride_ISO_Currency_Code[] = "6";
  const char SecurityIDSourceOverride_Exchange_symbol[] = "8";
  const char SecurityIDSourceOverride_TBA_OUTRIGHT[] = "403";
  const char SecurityIDSourceOverride_TBA_ROLL[] = "404";
