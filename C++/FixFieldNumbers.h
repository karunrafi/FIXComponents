...
namespace FIX
{
  namespace FIELD
  {
    ...
    const int MonitorRequestID = 22056;
    ...
    const int MonitorRequestStatus = 22069;
    const int ClearPageIndicator = 22302;
    const int MonitorPageNumRows = 22303;
    const int MonitorPageNumColumns = 22304;
    const int RowSpanStartColumn = 22339;
    const int RowSpanLength = 22340;
    const int RowSpanText = 22341;
    const int RowSpanAttribute = 22342;
    const int MDPriceVolumeLevel = 22588;
  }
}
